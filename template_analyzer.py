...
import streamlit as st  # ← [핵심] 이 import가 빠져서 NameError가 발생했습니다!
...
def extract_template_info(src) -> tuple:
    ...
    try:
        ...
        mid_category = sorted(mid_cats)[0]
...
def load_auto_rules() -> dict:
    ...
    try:
        ...
        # 이제 st가 정의되어 있으므로 NameError가 발생하지 않습니다
